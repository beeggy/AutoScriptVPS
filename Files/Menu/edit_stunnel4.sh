...
echo -e "\e[0m                                                   "
echo -e "\e[92m                  Stunnel4  Port                  "
echo -e "\e[92m                        "$stunnel4port
echo -e "\e[0m                                                   "
...
if [ $? -eq 0 ]; then
	...
	if grep -Fxq $Port_New /root/opensshport; then
		echo -e "\e[0m                                                   "
		echo -e "\e[94m              OpenSSH Port Conflict              "
		echo -e "\e[94m              Port Is Already In Use              "
		echo -e "\e[0m                                                   "
		echo -e "\e[95m※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※\e[0m"
		exit
	fi
	...
	if grep -Fxq $Port_New /root/openvpnport; then
		echo -e "\e[0m                                                   "
		echo -e "\e[34m              Openvpn Port Conflict               "
		echo -e "\e[34m              Port Is Already In Use              "
		echo -e "\e[0m                                                   "
		echo -e "\e[32m※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※\e[0m"
		exit
	fi
