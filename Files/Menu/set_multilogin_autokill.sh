...
echo -e "\e[0m                                                   "
echo -e "\e[92m            [1]  AutoKill After 5 Minutes"
echo -e "\e[93m            [2]  AutoKill After 15 Minutes"
echo -e "\e[94m            [3]  AutoKill After 30 Minutes"
echo -e "\e[95m            [4]  Turn Off AutoKill/MultiLogin"
echo -e "\e[93m            [x]  Exit"
echo -e "\e[0m                                                   "
...
case $AutoKill in
		...
		echo -e "\e[0m                                                   "
		echo -e "\e[92m             Allowed MultiLogin : "$MultiLogin
		echo -e "\e[92m             AutoKill Every     : 5 Minutes"
		echo -e "\e[0m                                                   "
		echo -e "\e[95m※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※\e[0m"
		exit
		;;
		...
		echo -e "\e[0m                                                   "
		echo -e "\e[92m             Allowed MultiLogin : "$MultiLogin
		echo -e "\e[92m             AutoKill Every     : 15 Minutes"
		echo -e "\e[0m                                                   "
		echo -e "\e[95m※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※\e[0m"
		exit
		;;
		...
		echo -e "\e[0m                                                   "
		echo -e "\e[92m             Allowed MultiLogin : "$MultiLogin
		echo -e "\e[92m             AutoKill Every     : 30 Minutes"
		echo -e "\e[0m                                                   "
		echo -e "\e[95m※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※\e[0m"
		exit
		;;
		...
		echo -e "\e[92m           AutoScriptVPS by  Beeggy           "
		echo -e "\e[0m                                                   "
		echo -e "\e[92m              AutoKill MultiLogin Turned               "
		echo -e "\e[0m                                                   "
		echo -e "\e[95m※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※\e[0m"
		exit
		;;
